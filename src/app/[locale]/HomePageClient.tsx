    ...
    "@graph": [
      {
        ...
        description:
          "Complete Subnautica 2 Wiki covering crafting, biomes, creatures, items, achievements, lore, and survival tips for the surreal voxel sandbox on Steam.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "Subnautica 2 - Surreal Voxel Survival Sandbox",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "Subnautica 2 Wiki",
        alternateName: "Subnautica 2",
        url: siteUrl,
        description:
          "Complete Subnautica 2 Wiki resource hub for crafting, biomes, creatures, items, achievements, and survival guides",
        logo: {
          "@type": "ImageObject",
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "Subnautica 2 Wiki - Surreal Voxel Survival Sandbox",
        },
        sameAs: [
          "https://store.steampowered.com/app/1962700/Subnautica_2/",
          "https://discord.gg/subnautica",
          "https://www.reddit.com/r/subnautica/",
          "https://www.youtube.com/@Subnautica",
        ],
      },
      {
        "@type": "VideoGame",
      ...
      {
        "@type": "VideoObject",
        name: "Subnautica 2 Early Access Gameplay Trailer",
        description:
          "Official Subnautica 2 video featuring the Steam launch trailer and gameplay preview.",
        uploadDate: "2026-05-12",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/xVG4LmFQ5QY",
        url: "https://www.youtube.com/watch?v=xVG4LmFQ5QY",
      },
    ],
  };
            ...
            {t.modules.lucidBlocksCreaturesAndEnemies.creatures.map(
              (c: any, index: number) => (
                ...
                >
                  <div className="mb-3">
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${["Hostile Enemy", "Major Threat", "Elite Threat"].includes(c.role) ? "bg-[hsl(var(--nav-theme-light))]/10 border-[hsl(var(--nav-theme)/0.35)] text-[hsl(var(--nav-theme-light))]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {c.role}
                    </span>
                  </div>
              ...
              (p: any, index: number) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${p.priority === "Essential" ? "bg-[hsl(var(--nav-theme-light))]/10 border-[hsl(var(--nav-theme)/0.35)] text-[hsl(var(--nav-theme-light))]" : p.priority === "Very High" ? "bg-orange-500/10 border-orange-500/30 text-orange-400" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {p.priority}
                    </span>
                  </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://discord.gg/subnautica"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://www.reddit.com/r/subnautica/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
